package com.example.suiyuancaipiao.view.sensor;
...
public abstract class ShakeListener implements SensorEventListener
{
	...
	private long duration = 100; // 时间比较间隔
	private float total;// 累加
	private float switchValue = 300;// 判断手机摇晃的阈值
	...
	public void onSensorChanged(SensorEvent event)
	{
		...
		} else
		{
			...
			if ((currenttime - lasttime) >= duration)
			{
				...
				// 屏蔽掉微小的增量
				float dx = Math.abs(x - lastX);// 每种坐标之间的增量
