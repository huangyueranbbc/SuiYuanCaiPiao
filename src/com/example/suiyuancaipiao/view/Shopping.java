...
public class Shopping extends BaseUI
{
	...
	public void init()
	{
		...
		addOptional = (Button) findViewById_(R.id.ii_add_optional);
		addRandom = (Button) findViewById_(R.id.ii_add_random);
		shoppingListClear = (ImageButton) findViewById_(R.id.ii_shopping_list_clear);
		notice = (TextView) findViewById_(R.id.ii_shopping_lottery_notice);
		buy = (Button) findViewById_(R.id.ii_lottery_shopping_buy);
		shoppingList = (ListView) findViewById_(R.id.ii_shopping_list);
	...
	private void changeNotice()
	{
		...
		{ "NUM", "MONEY" }, new String[]
		{ lotterynumber.toString(), lotteryvalue.toString() });
