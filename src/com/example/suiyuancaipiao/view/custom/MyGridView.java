package com.example.suiyuancaipiao.view.custom;
...
import com.example.suiyuancaipiao.util.DensityUtil;
...
public class MyGridView extends GridView
{
	...
	public MyGridView(Context context, AttributeSet attrs)
	{
		...
		// disappears. Set to -1 for the default animation, 0 for no animation,
	...
	private void showPop(TextView child)
	{
		...
		// bottom-left corner of the anchor view.
